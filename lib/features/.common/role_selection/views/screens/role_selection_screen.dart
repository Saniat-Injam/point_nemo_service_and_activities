...
import 'package:point_nemo_service_and_activities/features/.common/role_selection/controllers/role_selection_controller.dart';
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              // Role options
              _buildRoleOption(context, controller, index: 0, title: AppLocalizations.of(context)!.userRole),
              SizedBox(height: 16.h),
              _buildRoleOption(context, controller, index: 1, title: AppLocalizations.of(context)!.businessOwnerRole),
              SizedBox(height: 16.h),
              _buildRoleOption(context, controller, index: 2, title: AppLocalizations.of(context)!.captainRole),
              ...
              CustomSubmitButton(
                ...
                color: const Color(0xFF040A18), // Dark navy
