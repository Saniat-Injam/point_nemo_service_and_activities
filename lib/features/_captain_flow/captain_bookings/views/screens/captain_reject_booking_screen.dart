...
import 'package:point_nemo_service_and_activities/features/_captain_flow/captain_bookings/views/widgets/captain_reject_booking_dialog.dart';
import 'package:point_nemo_service_and_activities/core/localization/app_localizations.dart';

class RejectBookingScreen extends StatelessWidget {
  const RejectBookingScreen({super.key});

  @override
  Widget build(BuildContext context) {
    final controller = Get.find<RejectBookingController>();

    return Scaffold(
      backgroundColor: Colors.white,
      appBar: CustomAppBar(
        title: AppLocalizations.of(context)!.rejectBookingTitle,
        titleSize: 20.sp,
          ...
          child: Column(
            ...
            children: [
              ...
              GestureDetector(
                onTap: () {
                  Get.dialog(
                    const CaptainRejectBookingDialog(),
  ...
  Widget _buildReasonItem(String reason, RejectBookingController controller) {
    return Obx(() {
      ...
      return GestureDetector(
        ...
        child: Container(
          ...
          child: Row(
            crossAxisAlignment:
                CrossAxisAlignment.start, // Align to top in case text wraps
            children: [
              // Checkbox
              Container(
                width: 22.w,
