...
class ServiceReviewSection extends StatelessWidget {
  const ServiceReviewSection({super.key});
  ...
  String _formatTimeAgo(BuildContext context, String iso) {
    ...
    try {
      ...
      if (difference.inDays > 30) return AppLocalizations.of(context)!.monthsAgo((difference.inDays / 30).floor().toString());
            ...
            Center(
              child: Column(
                children: [
                  ...
                  SizedBox(height: 8.h),
                  Text(
                    AppLocalizations.of(context)!.noServiceReviews,
